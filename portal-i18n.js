(function installPortalI18n(global) {
  ...
  const dictionaries = {
    en: {
      ...
      "runs.ours": "Our optimizers",
      "runs.paper": "Paper optimizers",
      ...
      "chart.scale": "Scale",
      "chart.view": "View",
      "chart.reset_view": "Reset view",
      "chart.zoom_in": "Zoom in",
      "chart.zoom_out": "Zoom out",
      "chart.gesture_hint": "Scroll to zoom · Drag to pan · Scroll on Y axis to adjust loss",
      "chart.empty_window": "No observations in this range. Reset view to return.",
      "chart.full": "Full",
      "chart.zoom": "Zoom",
      "chart.tail": "Tail",
    ...
    zh: {
      ...
      "chart.scale": "尺度",
      "chart.view": "视图",
      "chart.reset_view": "重置视图",
      "chart.zoom_in": "放大视图",
      "chart.zoom_out": "缩小视图",
      "chart.gesture_hint": "滚轮缩放 · 拖动平移 · 纵轴滚轮调整 loss",
      "chart.empty_window": "当前范围无观测，可重置视图返回。",
      "chart.full": "全程",
      "chart.zoom": "放大",
      "chart.tail": "尾段",
      "chart.emphasis": "重点",
